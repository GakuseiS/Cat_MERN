...
const Form = () => {
    ...
    const success = <p className='form__success'>Ваши данные отправлены на сервер. Ожидайте нашего звонка.</p>
        ...
        <form className='form' onSubmit={submitHandler}>
            ...
            <div className='form__wrapper'>
                <div className='form__wrapper-name'>
                    ...
                    <input className='form__input-text form__input-text--name' id='name' type='text' placeholder='БАРСИК' name='name' required/>
                    <label className='form__label' htmlFor='weight'>Вес (кг):*</label>
                    <input className='form__input-text form__input-text--weight' id='weight' type='number' min='0' placeholder='7' name='weight' required/>
                    <label className='form__label' htmlFor='age'>Возраст (лет):</label>
                    <input className='form__input-text form__input-text--age' id='age' type='number' min='0' placeholder='7' name='age'/>
                </div>
            ...
            <div className='form__contacts'>
                ...
                <div className='form__wrapper-contacts'>
                    ...
                    <input className='form__input-text form__input-text-mail' id='mail' type='email' placeholder='example@gmail.com' name='email' required/>
                    <label className='form__label' htmlFor='tel'>Телефон:*</label>
                    <input className='form__input-text form__input-text-tel' id='tel' type='tel' placeholder='8 (800) 900-60-90' name='tel' required/>
                </div>
            </div>
            ...
            <Button size='large' type='submit'>Отправить заявку</Button>
